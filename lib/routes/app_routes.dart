...
import '../views/riwayat/riwayat_screen.dart';
...
class AppRoutes {
  ...
  static final List<GetPage> pages = [
    ...
    GetPage(name: onboarding,      page: () => const OnboardingScreen(),        transition: Transition.rightToLeft),
    ...
    GetPage(name: forgotPassword,  page: () => const ForgotPasswordScreen(),    transition: Transition.rightToLeft),
    GetPage(name: home,            page: () => const HomeScreen(),              transition: Transition.fadeIn),
    GetPage(name: pemasukan,       page: () => const PemasukanScreen(),         transition: Transition.rightToLeft),
    GetPage(name: pengeluaran,     page: () => const PengeluaranScreen(),       transition: Transition.rightToLeft),
    GetPage(name: insight,         page: () => const InsightScreen(),           transition: Transition.rightToLeft),
    GetPage(name: scan,            page: () => const ScanScreen(),              transition: Transition.bottomToTop),
    GetPage(name: detailTransaksi, page: () => const DetailTransaksiScreen(),   transition: Transition.rightToLeft),
  ];
}

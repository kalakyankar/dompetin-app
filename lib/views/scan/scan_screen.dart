    ...
    return Scaffold(
      ...
      body: Obx(() {
        switch (ctrl.currentStep.value) {
          case ScanStep.permission: return _PermissionStep(ctrl: ctrl);
          case ScanStep.intro:     return _IntroStep(ctrl: ctrl);
          case ScanStep.camera:    return _CameraStep(ctrl: ctrl);
          case ScanStep.analyzing: return _AnalyzingStep(ctrl: ctrl);
          case ScanStep.result:    return _ResultStep(ctrl: ctrl);
          case ScanStep.success:   return _SuccessStep(ctrl: ctrl);
        }
      }),
    );
  }
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Center(child: Container(
            ...
            child: const Icon(Icons.camera_alt_rounded, color: Colors.white, size: 46),
          )),
        ),
        const SizedBox(height: 32),
        Text('Aktifkan Kamera', style: AppTheme.heading2),
        const SizedBox(height: 12),
        Text('Gunakan kamera Anda untuk memindai struk belanja dan mengelola anggaran secara otomatis.',
        ...
        Container(
          ...
          child: Row(children: [
            Container(width: 32, height: 32,
                ...
                child: const Icon(Icons.shield_outlined, color: Color(0xFF22C55E), size: 18)),
            const SizedBox(width: 12),
            const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Privasi Terjamin', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Center(child: Stack(alignment: Alignment.center, children: [
            ...
            const Icon(Icons.document_scanner_outlined, color: Colors.white, size: 52),
          ])),
        ),
        const SizedBox(height: 36),
        Text('Scan struk dan pencatatan\notomatis',
            style: AppTheme.heading2.copyWith(fontSize: 22), textAlign: TextAlign.center),
        const SizedBox(height: 16),
        Text('Kelola keuangan Anda tanpa repot. Cukup foto struk, dan biar AI kami yang merapikannya untuk Anda.',
            style: AppTheme.body, textAlign: TextAlign.center),
        const Spacer(),
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return Stack(children: [
          if (ready && cam != null)
            ...
            Positioned.fill(child: Container(color: Colors.black87,
                child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Memuat kamera...', style: TextStyle(
                      color: Colors.white.withOpacity(0.7), fontSize: 14, fontFamily: 'Poppins')),
                ])))),
          ...
          SafeArea(child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Container(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                  ...
                  child: const Text('Scan Struk', style: TextStyle(color: Colors.white,
                      fontSize: 13, fontWeight: FontWeight.w600, fontFamily: 'Poppins'))),
              _CircleBtn(icon: Icons.photo_library_outlined, onTap: ctrl.pickFromGallery),
            ]),
          )),
          ...
          // Hint
          Center(child: Transform.translate(offset: const Offset(0, 145),
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 7),
                decoration: BoxDecoration(color: AppTheme.primaryBlue.withOpacity(0.85),
                    borderRadius: BorderRadius.circular(20)),
                child: const Row(mainAxisSize: MainAxisSize.min, children: [
                  Icon(Icons.document_scanner_outlined, color: Colors.white, size: 13),
                  SizedBox(width: 6),
                  Text('Arahkan ke struk belanja', style: TextStyle(color: Colors.white,
          ...
          Positioned(bottom: 48, left: 0, right: 0, child: Column(children: [
            ...
            const SizedBox(height: 12),
            const Text('Foto Struk', style: TextStyle(color: Colors.white,
...
class _Viewfinder extends StatelessWidget {
  @override
  Widget build(BuildContext context) => SizedBox(width: 260, height: 380,
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      if (ctrl.scannedImagePath.value.isNotEmpty)
        Positioned.fill(child: Image.file(File(ctrl.scannedImagePath.value), fit: BoxFit.cover))
      else
        Container(color: Colors.black87),
      Positioned.fill(child: Container(color: Colors.black.withOpacity(0.55))),

      // Viewfinder with scan line
      Center(child: SizedBox(width: 260, height: 380,
          child: Stack(children: [
            const SizedBox(width: 260, height: 380,
                child: CustomPaint(painter: _VfPainter())),
            Obx(() => Positioned(
              ...
              child: Container(height: 2,
                  decoration: const BoxDecoration(gradient: LinearGradient(colors: [
                    Colors.transparent, AppTheme.primaryBlue, Colors.transparent]))),
            )),
          ]))),
      ...
      Positioned(bottom: 60, left: 0, right: 0, child: Column(children: [
        Obx(() => Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(ctrl.analysisStatus.value, style: const TextStyle(color: Colors.white,
      ...
      appBar: AppBar(
        ...
        leading: GestureDetector(
          ...
          child: Container(margin: const EdgeInsets.all(10),
              decoration: BoxDecoration(border: Border.all(color: AppTheme.inputBorder),
                  borderRadius: BorderRadius.circular(10)),
              child: const Icon(Icons.arrow_back_ios_new_rounded, size: 16, color: AppTheme.textDark)),
        ),
        title: const Text('Detail Transaksi', style: TextStyle(fontSize: 16,
        ...
        return SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: AppTheme.primaryBlue.withOpacity(0.06),
                  borderRadius: BorderRadius.circular(12),
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Tentang analisis lengkap', style: TextStyle(fontSize: 13,
                      fontWeight: FontWeight.w600, color: AppTheme.primaryBlue, fontFamily: 'Poppins')),
                  Text('Dompetin telah memindai struk Anda dengan akurat. Mohon verifikasi detail dibawah ini.',
            ...
            _Card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              TextField(controller: ctrl.nameController, style: AppTheme.label,
              ...
              const SizedBox(height: 8),
              Obx(() => Wrap(spacing: 8, runSpacing: 6,
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: sel ? AppTheme.primaryBlue : AppTheme.inputFill,
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                              color: sel ? AppTheme.primaryBlue : AppTheme.inputBorder),
                        ),
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Obx(() => GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: AppTheme.inputFill,
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(color: AppTheme.inputBorder)),
                      child: Row(children: [
                        const Icon(Icons.calendar_today_outlined, size: 14, color: AppTheme.textGrey),
                        const SizedBox(width: 6),
                        Text(ctrl.selectedDate.value == null ? 'Tanggal'
                            : '${ctrl.selectedDate.value!.day} Mei ${ctrl.selectedDate.value!.year}',
                            style: AppTheme.bodySmall.copyWith(color: AppTheme.textDark, fontSize: 12)),
                      ]),
                    ),
                  )),
                ])),
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Obx(() => Container(
                    ...
                    child: Row(children: [
                      ...
                      const SizedBox(width: 6),
                      Text(ctrl.selectedTime.value.isEmpty ? '--:-- WIB' : ctrl.selectedTime.value,
                          style: AppTheme.bodySmall.copyWith(color: AppTheme.textDark, fontSize: 12)),
                    ]),
                  )),
                ])),
              ...
              Obx(() => DropdownButtonFormField<String>(
                value: ctrl.selectedPaymentMethod.value,
                items: ctrl.paymentMethods.map((m) => DropdownMenuItem(
                ...
                onChanged: (v) { if (v != null) ctrl.selectedPaymentMethod.value = v; },
            ...
            if (ctrl.editableItems.isNotEmpty)
              _Card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ...ctrl.editableItems.map((item) => Padding(
                    ...
                    child: Row(children: [
                      Expanded(child: Text('${item.qty}x ${item.name}',
                          style: AppTheme.body.copyWith(color: AppTheme.textDark))),
                      Text(ctrl.formatRupiah(item.total), style: AppTheme.label),
                    ]))),
                if (ctrl.parsedReceipt.value?.cashGiven != null &&
                  ...
                  _SummaryRow('Tunai',
                      ctrl.formatRupiah(ctrl.parsedReceipt.value!.cashGiven)),
                ],
                const Divider(color: AppTheme.divider, height: 16),
                _SummaryRow('Total', ctrl.formatRupiah(ctrl.effectiveTotal), bold: true),
        ...
        return SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Text('Pengeluaran berhasil dicatat',
                style: AppTheme.heading2.copyWith(fontSize: 20), textAlign: TextAlign.center),
            const SizedBox(height: 10),
            Text('Dan telah aman disimpan pada pencatatan riwayat keuangan Anda.',
                style: AppTheme.body, textAlign: TextAlign.center),
            const SizedBox(height: 28),
            ...
            _Card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                    decoration: BoxDecoration(color: const Color(0xFF22C55E).withOpacity(0.1),
                        borderRadius: BorderRadius.circular(20)),
                    child: const Text('Sukses', style: TextStyle(fontSize: 11,
                        fontWeight: FontWeight.w600, color: Color(0xFF22C55E), fontFamily: 'Poppins'))),
              ]),
              const SizedBox(height: 6),
              ...
              const SizedBox(height: 16),
              Row(children: [
                Expanded(child: _InfoChip(label: 'Item', value: '${r.itemCount} Item')),
                const SizedBox(width: 10),
                Expanded(child: _InfoChip(label: 'Kategori', value: ctrl.selectedCategory.value)),
              ]),
              const SizedBox(height: 12),
              // Asal Saldo
              const Text('Asal Saldo', style: TextStyle(fontSize: 12, color: AppTheme.textGrey,
                  fontFamily: 'Poppins')),
              const SizedBox(height: 8),
              Obx(() => Row(children: ctrl.asalSaldoOptions.map((opt) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSel ? AppTheme.primaryBlue : AppTheme.inputFill,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                          color: isSel ? AppTheme.primaryBlue : AppTheme.inputBorder),
                    ),
                    child: Text(opt, style: TextStyle(fontSize: 12,
                        fontWeight: FontWeight.w500, fontFamily: 'Poppins',
            ...
            _Card(child: Column(children: [
              _DetailRow('Jumlah Transaksi', ctrl.formatRupiah(ctrl.effectiveTotal),
...
class _SummaryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
    ...
    children: [
      ...
      Text(value, style: TextStyle(fontSize: 13, fontFamily: 'Poppins',
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Row(children: [
        ...
        Text(value, style: TextStyle(fontSize: large ? 15 : 13,
            fontWeight: large ? FontWeight.w700 : FontWeight.w500,
            color: valueColor ?? AppTheme.textDark, fontFamily: 'Poppins')),
      ]),
    ]),
  );
}
...
class _Btn extends StatelessWidget {
  ...
  const _Btn({required this.label, required this.onTap, this.isLoading = false});

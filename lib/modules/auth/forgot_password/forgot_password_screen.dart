...
import 'package:dompetin_app/modules/auth/forgot_password/forgot_password_controller.dart';
    ...
    return Column(
      ...
      children: [
        ...
        if (subtitle != null) ...[
          ...
          Text(subtitle!, style: AppTheme.body, textAlign: TextAlign.center),
        ],
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          _StepHeader(controller: controller, title: 'Lupa Kata Sandi'),
